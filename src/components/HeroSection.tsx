...
import imgImg1 from "figma:asset/ec901f1c0d6bdc3abb3b7f2578c96a444ee001e2.png";
import imgImg2 from "figma:asset/410c340aa057242400c608368f918307cdd72438.png";
import imgImg3 from "figma:asset/ed0619350d8c5bd22cee2ec24b1a7ae47b6e5494.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/80 border border-[rgba(107,77,124,0.25)] rounded-full backdrop-blur-sm shadow-lg">
              ...
              <span className="text-base text-[#4a4a4a]">Trusted by 10,000+ families</span>
            </div>
            ...
            <div>
              ...
              <div className="w-[300px] h-4 relative -mt-2">
                <svg className="w-full h-full" viewBox="0 0 300 12" fill="none">
                  <path d={svgPaths.p124a4580} stroke="#6B4D7C" strokeWidth="3.5" strokeLinecap="round" />
                </svg>
              </div>
            </div>
            ...
            <p className="text-[#5a5a5a] text-lg leading-relaxed max-w-xl">
              World-class neonatal and pediatric intensive care, now in Mumbai. From high-risk newborns to cardiac critical care - every child receives compassionate, evidence-based treatment.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 pt-4 border-t-2 border-[rgba(107,77,124,0.15)]">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  <img src={imgImg} alt="" className="w-11 h-11 rounded-full border-3 border-white object-cover shadow-md" />
                  <img src={imgImg1} alt="" className="w-11 h-11 rounded-full border-3 border-white object-cover shadow-md" />
                  <img src={imgImg2} alt="" className="w-11 h-11 rounded-full border-3 border-white object-cover shadow-md" />
                ...
                <div>
                  <div className="flex gap-0.5 mb-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-[#6B4D7C] text-[#6B4D7C]" />
                    ))}
                  </div>
                  <p className="text-sm text-[#5a5a5a]">5.0 from happy parents</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[rgba(207,237,234,0.4)] flex items-center justify-center flex-shrink-0 shadow-sm">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                    <path d="M8 2V5M16 2V5M3.5 9.09H20.5M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z" stroke="#6B4D7C" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M15.6947 13.7H15.7037M15.6947 16.7H15.7037M11.9955 13.7H12.0045M11.9955 16.7H12.0045M8.29431 13.7H8.30329M8.29431 16.7H8.30329" stroke="#6B4D7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="text-sm text-[#2a2a2a] mb-1">Next Available</p>
                  <p className="text-xs text-[#5a5a5a] mb-2">Tomorrow, 9:00 AM</p>
                  <button className="text-xs text-[#6B4D7C] hover:underline">Quick book →</button>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[rgba(107,77,124,0.25)] flex items-center justify-center flex-shrink-0 shadow-sm">
                  <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none">
                    <path d="M9.99996 18.3334C14.6023 18.3334 18.3333 14.6024 18.3333 10C18.3333 5.39765 14.6023 1.66669 9.99996 1.66669C5.39759 1.66669 1.66663 5.39765 1.66663 10C1.66663 14.6024 5.39759 18.3334 9.99996 18.3334Z" stroke="#6B4D7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M6.45831 10L8.81665 12.3584L13.5416 7.64169" stroke="#6B4D7C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
                  <p className="text-sm text-[#2a2a2a]">Board Certified</p>
                  <p className="text-xs text-[#5a5a5a]">Pediatric Specialists</p>
                </div>
              </div>
            </div>
          </div>
